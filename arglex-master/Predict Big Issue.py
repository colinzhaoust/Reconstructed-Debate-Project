...
target_list = ["political_ideology", "religious_ideology", "gender", "education"]
...
unbalanced_xTr, unbalanced_yTr = get_training_set(valid_users, debates, "Drug Legalization", big_issues_list, criterion)
